              ...
              <NavigationMenuList>
                <NavigationMenuItem>
                  <Link href="/" legacyBehavior passHref>
                    <NavigationMenuLink
                      className={cn(
                        "group inline-flex h-10 w-max items-center justify-center rounded-md px-4 py-2 text-sm font-medium text-white transition-colors hover:bg-white/20 hover:text-white focus:bg-white/20 focus:text-white focus:outline-none disabled:pointer-events-none disabled:opacity-50",
                      )}
                    >
                      HOME
                    </NavigationMenuLink>
                      ...
                      {rooms.map((room) => (
                        <li key={room.title}>
                          <NavigationMenuLink asChild>
                            ...
                            >
                              <div className="text-sm font-medium leading-none">{room.title}</div>
                ...
                {["CONFERENCE HALL", "GALLERY", "ABOUT", "CONTACT"].map((item) => (
