...
export const metadata: Metadata = {
    ...
    alternates: {
        canonical: buildAbsoluteUrl("/rooms/suite"),
    },
}
            ...
            <main className="relative min-h-screen">
                ...
                <section className="mx-auto py-16 max-w-[1440px]">
                    <SectionTitle
                        ...
                        description={
                            <PriceInfo className="mt-6" price="6500" />
                        }
                        className="mb-12"
                    />
                    <p className="px-4 text-center text-muted-foreground">
                        Dekyil Guest House&apos;s suite room provides a
                        luxurious experience to your stay in Bumthang. The large
                        window panes offer an expansive view of the Chamkhar
                        valley and also make for a great workplace. The floor
                        heating systems in the bathroom also make for a
                        delightful surprise in the freezing winters of Bumthang.
                    </p>
