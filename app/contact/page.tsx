                    ...
                    <div className="grid gap-8 md:grid-cols-2">
                            ...
                            <Card className="rounded-none">
                                ...
                                <CardContent className="space-y-4">
                                    ...
                                    <div className="flex items-center space-x-2">
                                        ...
                                        <p>
                                            Check-in: 11:00 AM, Check-out: 01:00
                                            PM
                                        </p>
                                    </div>
                                </CardContent>
                        ...
                        <div className="space-y-8">
                            <Card className="rounded-none">
                                ...
                                <CardContent>
                                    <p className="mb-4 ">
                                        Dekyil Guest House is nestled in the
                                        heart of Chamkhar Town, Bumthang
                                        offering a perfect blend of traditional
                                        Bhutanese hospitality and modern
                                        comfort. Our location provides easy
                                        access to local attractions and
                                        breathtaking views of the surrounding
                                        landscape.
                                    </p>
                                    <p className="">
                                        We&apos;re just a short 5 minute walk
                                        from the main town and placed
                                        conveniently in the middle of all
                                        attractions. Our friendly staff can
                                        provide recommendations for local
                                        experiences and arrange transportation
                                        for your adventures in Bumthang.
                                    </p>
                                </CardContent>
                            </Card>
                            ...
                            <Card className="rounded-none">
                                ...
                                <CardContent>
                                    ...
                                    <p className="mt-4 ">
                                        Wake up to stunning views of the
                                        Bumthang valley and surrounding
                                        mountains. Our guest house offers a
                                        tranquil retreat after a day of
                                        exploring the beauty of Bhutan.
                                    </p>
                                </CardContent>
                            </Card>
                        </div>
